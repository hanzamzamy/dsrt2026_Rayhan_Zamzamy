...
C {code.sym} 370 -350 0 0 {name=s1 only_toplevel=false value="tcleval(.include $::CHIP_ROOT/testbench/spice/code/even_parity_gen_xor_12t_ub.spice)"}
C {schematic/even_parity_gen_xor_12t_ub.sym} 190 -140 0 0 {name=x1}
