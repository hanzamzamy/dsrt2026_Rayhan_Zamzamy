...
N 100 -360 110 -360 {lab=VDD}
N 100 -330 110 -330 {lab=GND}
...
N -460 -370 -430 -370 {lab=I0}
N -460 -350 -430 -350 {lab=I1}
N -460 -160 -430 -160 {lab=I2}
N -460 -140 -430 -140 {lab=I3}
N -460 50 -430 50 {lab=I4}
N -460 70 -430 70 {lab=I5}
N -460 260 -430 260 {lab=I6}
N -460 280 -430 280 {lab=I7}
N -290 -360 -230 -360 {lab=#net1}
N -290 -150 -230 -150 {lab=#net2}
N -230 -260 -200 -260 {lab=#net1}
N -230 -240 -200 -240 {lab=#net2}
N -290 60 -230 60 {lab=#net3}
N -290 270 -230 270 {lab=#net4}
N -230 160 -200 160 {lab=#net3}
N -230 180 -200 180 {lab=#net4}
N -60 170 -0 170 {lab=#net5}
N 0 -50 30 -50 {lab=#net6}
N 0 -30 30 -30 {lab=#net5}
N -60 -250 0 -250 {lab=#net6}
N 260 -120 260 -110 {lab=VDD}
N 420 -120 420 -110 {lab=VDD}
N 260 30 260 40 {lab=GND}
N 420 30 420 40 {lab=GND}
N 170 -40 190 -40 {lab=#net7}
N 330 -40 350 -40 {lab=#net8}
N 490 -40 510 -40 {lab=O0}
C {iopin.sym} 100 -360 0 1 {name=p1 lab=VDD}
C {iopin.sym} 100 -330 0 1 {name=p2 lab=GND}
C {lab_wire.sym} -360 -440 0 0 {name=p3 sig_type=std_logic lab=VDD}
C {lab_wire.sym} 110 -360 0 1 {name=p4 sig_type=std_logic lab=VDD}
C {lab_wire.sym} 110 -330 0 1 {name=p5 sig_type=std_logic lab=GND}
...
C {opin.sym} 510 -40 0 0 {name=p29 lab=O0}
C {schematic/xor_6t.sym} -320 -270 0 0 {name=x1}
C {schematic/xor_6t.sym} -320 -60 0 0 {name=x2}
C {schematic/xor_6t.sym} -320 150 0 0 {name=x3}
C {schematic/xor_6t.sym} -320 360 0 0 {name=x4}
C {schematic/xor_6t.sym} -90 -160 0 0 {name=x5}
C {schematic/xor_6t.sym} -90 260 0 0 {name=x6}
C {schematic/xor_6t.sym} 140 50 0 0 {name=x7}
C {schematic/not_std.sym} 150 50 0 0 {name=x8}
C {schematic/not_std.sym} 310 50 0 0 {name=x9}
C {lab_wire.sym} 260 -120 0 0 {name=p19 sig_type=std_logic lab=VDD}
C {lab_wire.sym} 420 -120 0 0 {name=p28 sig_type=std_logic lab=VDD}
C {lab_wire.sym} 260 40 2 1 {name=p30 sig_type=std_logic lab=GND}
C {lab_wire.sym} 420 40 2 1 {name=p31 sig_type=std_logic lab=GND}
