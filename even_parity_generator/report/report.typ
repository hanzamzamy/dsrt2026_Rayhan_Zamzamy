...
#figure(
  table(
    ...
    [XNOR 6T (_Buffered_)], [68.19 ps], [20.17 ps], [14.64 ps], [603.99 nW], [1.88 nW], [41.19 aJ],
  ),
  kind: table,
...
#figure(
  table(
    ...
    [XOR 6T \ (_Unbalanced_)], [1.09 ns], [36.93 ns], [-27.82 ns], [10.82 µW], [6.16 nW], [11.74 fJ],
    [XOR 6T  (_Balanced_)], [211.40 ps], [-40.89 ns], [50.01 ns], [5.30 µW], [57.44 nW], [1.12 fJ],
    [XOR 12T \ (_Unbalanced_)], [771.07 ps], [62.75 ps], [57.68 ps], [48.66 µW], [194.61 nW], [37.52 fJ],
    [XOR 12T (_Balanced_)], [303.24 ps], [2.07 ns], [-1.97 ns], [28.88 µW], [97.65 nW], [8.76 fJ],
    [XNOR 6T (_Balanced_)], [253.38 ps], [29.76 ps], [25.59 ps], [24.88 µW], [25.28 nW], [6.30 fJ],
  ),
  kind: table,
...
#figure(
  grid(
    ...
    rows: (auto, auto, auto),
    gutter: 8pt,
    image("../simulation/spice/not_std/dc_vtc.svg", width: 100%),
    image("../simulation/spice/not_std/tran_output.svg", width: 100%),
    image("../simulation/spice/not_std/dc_gain.svg", width: 100%),
    image("../simulation/spice/not_std/tran_inputs.svg", width: 100%),
    image("../simulation/spice/not_std/tran_current.svg", width: 100%),
    image("../simulation/spice/not_std/tran_leakage.svg", width: 100%),
  ),
...
#figure(
  grid(
    ...
    rows: (auto, auto, auto),
    gutter: 8pt,
    image("../simulation/spice/xor_6t/dc_vtc.svg", width: 100%),
    image("../simulation/spice/xor_6t/tran_output.svg", width: 100%),
    image("../simulation/spice/xor_6t/dc_gain.svg", width: 100%),
    image("../simulation/spice/xor_6t/tran_inputs.svg", width: 100%),
    image("../simulation/spice/xor_6t/tran_current.svg", width: 100%),
    image("../simulation/spice/xor_6t/tran_leakage.svg", width: 100%),
  ),
...
#figure(
  grid(
    ...
    rows: (auto, auto, auto),
    gutter: 8pt,
    image("../simulation/spice/xor_12t/dc_vtc.svg", width: 100%),
    image("../simulation/spice/xor_12t/tran_output.svg", width: 100%),
    image("../simulation/spice/xor_12t/dc_gain.svg", width: 100%),
    image("../simulation/spice/xor_12t/tran_inputs.svg", width: 100%),
    image("../simulation/spice/xor_12t/tran_current.svg", width: 100%),
    image("../simulation/spice/xor_12t/tran_leakage.svg", width: 100%),
  ),
...
#figure(
  grid(
    ...
    rows: (auto, auto, auto),
    gutter: 8pt,
    image("../simulation/spice/xnor_6t_buf/dc_vtc.svg", width: 100%),
    image("../simulation/spice/xnor_6t_buf/tran_output.svg", width: 100%),
    image("../simulation/spice/xnor_6t_buf/dc_gain.svg", width: 100%),
    image("../simulation/spice/xnor_6t_buf/tran_inputs.svg", width: 100%),
    image("../simulation/spice/xnor_6t_buf/tran_current.svg", width: 100%),
    image("../simulation/spice/xnor_6t_buf/tran_leakage.svg", width: 100%),
  ),
...
#figure(
  grid(
    ...
    rows: (auto, auto, auto),
    gutter: 8pt,
    image("../simulation/spice/even_parity_gen_xor_6t_ub/tran_inputs_0_3.svg", width: 100%),
    image("../simulation/spice/even_parity_gen_xor_6t_ub/tran_inputs_4_7.svg", width: 100%),
    image("../simulation/spice/even_parity_gen_xor_6t_ub/tran_output.svg", width: 100%),
    image("../simulation/spice/even_parity_gen_xor_6t_ub/tran_verification.svg", width: 100%),
    image("../simulation/spice/even_parity_gen_xor_6t_ub/tran_current.svg", width: 100%),
    image("../simulation/spice/even_parity_gen_xor_6t_ub/tran_energy.svg", width: 100%),
  ),
...
#figure(
  grid(
    ...
    rows: (auto, auto, auto),
    gutter: 8pt,
    image("../simulation/spice/even_parity_gen_xor_6t/tran_inputs_0_3.svg", width: 100%),
    image("../simulation/spice/even_parity_gen_xor_6t/tran_inputs_4_7.svg", width: 100%),
    image("../simulation/spice/even_parity_gen_xor_6t/tran_output.svg", width: 100%),
    image("../simulation/spice/even_parity_gen_xor_6t/tran_verification.svg", width: 100%),
    image("../simulation/spice/even_parity_gen_xor_6t/tran_current.svg", width: 100%),
    image("../simulation/spice/even_parity_gen_xor_6t/tran_energy.svg", width: 100%),
  ),
...
#figure(
  grid(
    ...
    rows: (auto, auto, auto),
    gutter: 8pt,
    image("../simulation/spice/even_parity_gen_xor_12t_ub/tran_inputs_0_3.svg", width: 100%),
    image("../simulation/spice/even_parity_gen_xor_12t_ub/tran_inputs_4_7.svg", width: 100%),
    image("../simulation/spice/even_parity_gen_xor_12t_ub/tran_output.svg", width: 100%),
    image("../simulation/spice/even_parity_gen_xor_12t_ub/tran_verification.svg", width: 100%),
    image("../simulation/spice/even_parity_gen_xor_12t_ub/tran_current.svg", width: 100%),
    image("../simulation/spice/even_parity_gen_xor_12t_ub/tran_energy.svg", width: 100%),
  ),
...
#figure(
  grid(
    ...
    rows: (auto, auto, auto),
    gutter: 8pt,
    image("../simulation/spice/even_parity_gen_xor_12t/tran_inputs_0_3.svg", width: 100%),
    image("../simulation/spice/even_parity_gen_xor_12t/tran_inputs_4_7.svg", width: 100%),
    image("../simulation/spice/even_parity_gen_xor_12t/tran_output.svg", width: 100%),
    image("../simulation/spice/even_parity_gen_xor_12t/tran_verification.svg", width: 100%),
    image("../simulation/spice/even_parity_gen_xor_12t/tran_current.svg", width: 100%),
    image("../simulation/spice/even_parity_gen_xor_12t/tran_energy.svg", width: 100%),
  ),
...
#figure(
  grid(
    ...
    rows: (auto, auto, auto),
    gutter: 8pt,
    image("../simulation/spice/even_parity_gen_xnor_6t_buf/tran_inputs_0_3.svg", width: 100%),
    image("../simulation/spice/even_parity_gen_xnor_6t_buf/tran_inputs_4_7.svg", width: 100%),
    image("../simulation/spice/even_parity_gen_xnor_6t_buf/tran_output.svg", width: 100%),
    image("../simulation/spice/even_parity_gen_xnor_6t_buf/tran_verification.svg", width: 100%),
    image("../simulation/spice/even_parity_gen_xnor_6t_buf/tran_current.svg", width: 100%),
    image("../simulation/spice/even_parity_gen_xnor_6t_buf/tran_energy.svg", width: 100%),
  ),
